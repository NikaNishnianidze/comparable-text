...
export default function CompareTextCond() {
  return (
    <div className="flex flex-col">
      <div className="mb:block tb:block lp:hidden dk:hidden mb:flex mb:items-center mb:gap-[4px] mb:mt-[20px] tb:flex tb:items-center tb:gap-[4px] tb:mt-[24px] mb:pl-[16px] tb:pl-[30px]">
